...
public class SplineEditor : Editor {
    ...
    SplineNode AddClonedNode(SplineNode node) {
        ...
        SplineNode res = new SplineNode(node.position, node.direction,spline);
    ...
    void OnSceneGUI()
    {
        ...
        foreach (CubicBezierCurve curve in spline.GetCurves()) {
            Handles.DrawBezier(spline.transform.TransformPoint(curve.n1.position),
                ...
                spline.transform.TransformPoint(curve.GetInverseDirection1()),
                spline.transform.TransformPoint(curve.GetInverseDirection2()),
                CURVE_COLOR,
                null,
                3);
        }
